...
# created: 12-25-2019
# Modify Paradox theme that comes with oh-my-posh to my desired state.
# remove user and machine info
# update date format and move timestamp to the place of user@machine
# use prompt background color for text color of admin symbol and timestamp
# remove $lastCommandFailed symbol and prompt symbol
...
function Write-Theme {
    ...
    $timeStamp = Get-Date -Format HH:mm:ss.fffff
...
$sl.Colors.VirtualEnvBackgroundColor = [System.ConsoleColor]::Yellow
